...
export const name = 'lowrybe';
export const description = 'Spróbuj złowić rybę!';
...
export async function execute(message, args) {
    ...
    if (cooldowns.has(userId)) {
        ...
        if (Date.now() < expirationTime) {
            return message.reply(`🎣 Musisz poczekać jeszcze ${timeLeft} sekund zanim znowu zarzucisz wędkę!`);
        }
    }
